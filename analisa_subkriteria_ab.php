          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_hitung_subkriteria_ab.php">
                          <div class="form-group">
                              <div class="col-sm-10">
								...
								<tr>
									<td>0-3</td>
									<td> 
									<input type="text" name="ab1" value="1">
									</td>
									<td>
									<input type="text" name="ab2" value="<?php echo "$data[ab2]"; ?>">
									</td>  
									<td> 
									<input type="text" name="ab3" value="<?php echo "$data[ab3]"; ?>">
									</td>
									<td> 
									<input type="text" name="ab4" value="<?php echo "$data[ab4]"; ?>">
									</td>		
								</tr>
								<tr>
									<td>4-6</td>
									<td> 
									<input type="hidden" name="ab5" >
									</td>
									<td> 
									<input type="text" name="ab6" value="1">
									</td>
									<td> 
									<input type="text" name="ab7" value="<?php echo "$data[ab7]"; ?>">
									</td>
									<td> 
									<input type="text" name="ab8" value="<?php echo "$data[ab8]"; ?>">
									</td>
								</tr>
								<tr>
									<td>7-9</td>
									<td>
									<input type="hidden" name="ab9">
								</td>
									<td>
									<input type="hidden" name="ab10" >
									</td>
									<td> 
									<input type="text" name="ab11" value="1">
									</td>
									<td> 
									<input type="text" name="ab12" value="<?php echo "$data[ab12]"; ?>">
									</td>
								</tr>
									<tr>
									<td>>10</td>
									<td>
									<input type="hidden" name="ab13">
								</td>
									<td>
									<input type="hidden" name="ab14" >
									</td>
									<td> 
									<input type="hidden" name="ab15" >
									</td>
									<td> 
									<input type="text" name="ab16" value="1">
									</td>
								</tr>
								<tr>
									<td>Jumlah</td>
