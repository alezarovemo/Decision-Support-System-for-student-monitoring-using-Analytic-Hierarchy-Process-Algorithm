      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> EDIT DATA KRITERIA </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_update_data_kriteria.php">
                          <div class="form-group">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"> Nilai</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k2]"; ?>"></td>
                                  <td class="numeric">
								  <input type="hidden" name="id_kriteria2" value="<?php echo "$data[id_kriteria]"; ?>">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric">Nilai</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k3]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">Nilai</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k4]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>                             
                                  <td class="numeric">Nilai</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k5]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">Absensi</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k8]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">Absensi</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k9]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">Absensi</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k10]"; ?>"></td>
                                  <td class="numeric">
								  <select name="k10" class="form-control">
										 <option value="1" > 1.  Sama Pentingnya </option>
										 <option value="2" > 2.  Mendekati Sedikit Lebih Pentingnya </option>
										 <option value="3" > 3.  Sedikit Lebih Penting </option>
										 <option value="4" > 4.  Mendekati Lebih Penting Dari </option>
                              ...
                              <tr>
                                  <td class="numeric">Pelanggaran Tata Tertib</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k14]"; ?>"></td>
                                  <td class="numeric">
								  <select name="k14" class="form-control">
										 <option value="1" > 1.  Sama Pentingnya </option>
										 <option value="2" > 2.  Mendekati Sedikit Lebih Pentingnya </option>
										 <option value="3" > 3.  Sedikit Lebih Penting </option>
										 <option value="4" > 4.  Mendekati Lebih Penting Dari </option>
                              ...
                              <tr>
                                  <td class="numeric">Pelanggaran Tata Tertib</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k15]"; ?>"></td>
                                  <td class="numeric">
								  <select name="k15" class="form-control">
										 <option value="1" > 1.  Sama Pentingnya </option>
										 <option value="2" > 2.  Mendekati Sedikit Lebih Pentingnya </option>
										 <option value="3" > 3.  Sedikit Lebih Penting </option>
										 <option value="4" > 4.  Mendekati Lebih Penting Dari </option>
                              ...
                              <tr>
                                  <td class="numeric">Sikap</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[k20]"; ?>"></td>
                                  <td class="numeric"> 
								  <select name="k20" class="form-control">
										 <option value="1" > 1.  Sama Pentingnya </option>
										 <option value="2" > 2.  Mendekati Sedikit Lebih Pentingnya </option>
										 <option value="3" > 3.  Sedikit Lebih Penting </option>
										 <option value="4" > 4.  Mendekati Lebih Penting Dari </option>
