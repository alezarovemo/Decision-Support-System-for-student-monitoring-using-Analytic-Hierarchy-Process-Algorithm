      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DATA KRITERIA </h3>
                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[tlp]</td>
								 <td>
								<a href='edit_data_alternatif.php?nis=$data[nis]'>Edit</a>
								<a href='aksi_hapus_alternatif.php?nis=$data[nis]'>Hapus</a>
								<a href='analisa_alternatif.php?nis=$data[nis]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
