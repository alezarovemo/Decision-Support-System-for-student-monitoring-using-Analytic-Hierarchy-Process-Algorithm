      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> EDIT DATA SUBKRITERIA PELANGGARAN TATA TERTIB </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <?php
						include "koneksi.php";
						$sql="select * from t_ptt where
						id_ptt='$_GET[id_ptt]'";
						$tampil=mysql_query($sql);
						$data=mysql_fetch_array($tampil);
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_update_data_subkriteria_ptt.php">
                          <div class="form-group">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"> Tidak Pernah</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[t2]"; ?>"></td>
								  <input type="hidden" name="id_ptt2" value="<?php echo "$data[id_ptt]"; ?>">
                                  <td class="numeric">
                                  ...
                                  <td class="numeric">Kadang</td>
                              </tr>
                              <tr>
                                 
                                  <td class="numeric">Tidak Pernah</td>
								   <td class="numeric"><input type="text" value="<?php echo "$data[t3]"; ?>"></td>
                                  <td class="numeric">
                                  ...
                                  <td class="numeric"> Sering </td>
                              </tr>
                              <tr>
                                  <td class="numeric">Kadang</td>
								   <td class="numeric"><input type="text" value="<?php echo "$data[t6]"; ?>"></td>
                                  <td class="numeric">
