          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_hitung_subkriteria_pl.php">
                          <div class="form-group">
							...
							<table class="table table-bordered table-striped table-condensed" border="1" width='500' align="center" >
								...
								<tr>
									<td>Rajin</td>
									<td> 
									<input type="text" name="p1" value="1">
									</td>
									<td>
									<input type="text" name="p2" value="<?php echo "$data[p2]"; ?>">
									</td>  
									<td> 
									<input type="text" name="p3" value="<?php echo "$data[p3]"; ?>">
									</td>		
								</tr>
								<tr>
									<td>Sedang</td>
									...
									<td> 
									<input type="text" name="p5" value="1">
									</td>
									<td> 
									<input type="text" name="p6" value="<?php echo "$data[p6]"; ?>">
									</td>
								</tr>
								<tr>
									<td>Malas</td>
									...
									<td> 
									<input type="text" name="p9" value="1">
									</td>
								</tr>
								<tr>
									<td>Jumlah</td>
