      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DATA SUBKRITERIA NILAI AKADEMIK </h3>
                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[n12]</td>
								 <td>
								<a href='edit_data_subkriteria_na.php?id_nilai=$data[id_nilai]'>Edit</a>
								<a href='aksi_hapus_subkriteria_na.php?id_nilai=$data[id_nilai]'>Hapus</a>
								<a href='analisa_subkriteria_na.php?id_nilai=$data[id_nilai]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
