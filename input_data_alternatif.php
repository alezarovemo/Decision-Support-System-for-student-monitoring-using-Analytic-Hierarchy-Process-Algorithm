          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="POST" action="aksi_input_alternatif.php">
                          <div class="form-group">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"> <input type="text" name="nis" style="width:810px;" > </td>
                              </tr>
                              <tr>
                                 
                                  <td class="numeric">Nama</td>
                                  <td class="numeric"> <input type="text" name="nama" style="width:810px;" > </td>
                              </tr>
                              <tr>
                                  <td class="numeric">Tempat</td>
                                  <td class="numeric"><input type="text" name="tempat" style="width:810px;" ></td>
                              </tr>
                              <tr>                             
                                  <td class="numeric">Tanggal</td>
                                  <td class="numeric"><input type="date" name="tanggal" style="width:810px;" ></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"><input type="text" name="tlp" style="width:810px;" ></td>
                              </tr>
                              <tr>
