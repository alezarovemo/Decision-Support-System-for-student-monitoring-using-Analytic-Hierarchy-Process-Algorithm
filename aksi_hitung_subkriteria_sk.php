          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="POST" action="simpan_analisa_sk.php">
                          <div class="form-group">
                              <div class="col-sm-10">								
								...
								<input type="hidden" name="b_sk1" value="<?php echo "$D[4]"; ?>" >
								<input type="hidden" name="b_sk2" value="<?php echo "$D[9]"; ?>" >
								<input type="hidden" name="b_sk3" value="<?php echo "$D[14]"; ?>" >

								
								<input type="hidden" name="sk1" value="<?php echo "$C[0]"; ?>" >
								<input type="hidden" name="sk2" value="<?php echo "$C[1]"; ?>" >
								<input type="hidden" name="sk3" value="<?php echo "$C[2]"; ?>" >
								<input type="hidden" name="sk4" value="<?php echo "$C[3]"; ?>" >
								<input type="hidden" name="sk5" value="<?php echo "$C[4]"; ?>" >
								<input type="hidden" name="sk6" value="<?php echo "$C[5]"; ?>" >
								<input type="hidden" name="sk7" value="<?php echo "$C[6]"; ?>" >
								<input type="hidden" name="sk8" value="<?php echo "$C[7]"; ?>" >
								<input type="hidden" name="sk9" value="<?php echo "$C[8]"; ?>" >
								<input type="hidden" name="sk10" value="<?php echo "$C[9]"; ?>" >
								<input type="hidden" name="sk11" value="<?php echo "$C[10]"; ?>" >
								<input type="hidden" name="sk12" value="<?php echo "$C[11]"; ?>" >
								...
								<table>
								<form method="POST" action="cek_konsistensi_subkriteria_sk.php">
								<input type="hidden" name="b_sk1" value="<?php echo "$D[4]"; ?>" >
								<input type="hidden" name="b_sk2" value="<?php echo "$D[9]"; ?>" >
								<input type="hidden" name="b_sk3" value="<?php echo "$D[14]"; ?>" >
