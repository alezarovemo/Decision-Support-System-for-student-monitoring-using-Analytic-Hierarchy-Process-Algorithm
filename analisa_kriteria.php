      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> ANALISA KRITERIA </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <?php
						include "koneksi.php";
						$sql="select * from t_kriteria where
						id_kriteria='$_GET[id_kriteria]'";
						$tampil=mysql_query($sql);
						$data=mysql_fetch_array($tampil);
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_hitung_kriteria.php">
                          <div class="form-group">
                              <div class="col-sm-10">
								<table class="table table-bordered table-striped table-condensed" border="1" width='700' align="center" >
								<tr >
								...
								<tr>
									<td class="numeric" >AB</td>
									<td> 
									<input type="text" name="k1" value="1">
									</td>
									<td>
									<input type="text" name="k2" value="<?php echo "$data[k2]"; ?>">
									</td>  
									<td> 
									<input type="text" name="k3" value="<?php echo "$data[k3]"; ?>">
									</td>
									<td> 
									<input type="text" name="k4" value="<?php echo "$data[k4]"; ?>">
									</td>	
									<td> 
									<input type="text" name="k5" value="<?php echo "$data[k5]"; ?>">
									</td>
								</tr>
								<tr>
									<td class="numeric" >SK</td>
									<td> 
									<input type="hidden" name="k6" >
									</td>
									<td> 
									<input type="text" name="k7" value="1">
									</td>
									<td> 
									<input type="text" name="k8" value="<?php echo "$data[k8]"; ?>">
									</td>
									<td> 
									<input type="text" name="k9" value="<?php echo "$data[k9]"; ?>">
									</td>
									<td> 
									<input type="text" name="k10" value="<?php echo "$data[k10]"; ?>">
									</td>
								</tr>
								<tr>
									<td class="numeric" >PL</td>
									<td>
									<input type="hidden" name="k11">
									</td>
									<td>
									<input type="hidden" name="k12" >
									</td>
									<td> 
									<input type="text" name="k13" value="1">
									</td>
									<td> 
									<input type="text" name="k14" value="<?php echo "$data[k14]"; ?>">
									</td>
									<td>
									<input type="text" name="k15" value="<?php echo "$data[k15]"; ?>">
									</td>
								</tr>
									<tr>
									<td class="numeric" >PTT</td>
									...
									<td>
									<input type="hidden" name="k17" >
									</td>
									<td> 
									<input type="hidden" name="k18" >
									</td>
									<td> 
									<input type="text" name="k19" value="1">
									</td>
									<td>
									<input type="text" name="k20" value="<?php echo "$data[k20]"; ?>">
									</td>
								</tr>
								</tr>
									<tr>
									<td class="numeric" >NA</td>
									<td>
									<input type="hidden" name="k21">
									</td>
									<td>
									<input type="hidden" name="k22" >
									</td>
									<td> 
									<input type="hidden" name="k23" >
									</td>
									<td> 
									<input type="hidden" name="k24" >
									</td>
									<td>
									<input type="text" name="k25" value="1">
									</td>
								</tr>
								<tr>
