                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[t6]</td>
								 <td>
								<a href='edit_data_subkriteria_ptt.php?id_ptt=$data[id_ptt]'>Edit</a>
								<a href='aksi_hapus_subkriteria_ptt.php?id_ptt=$data[id_ptt]'>Hapus</a>
								<a href='analisa_subkriteria_ptt.php?id_ptt=$data[id_ptt]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
