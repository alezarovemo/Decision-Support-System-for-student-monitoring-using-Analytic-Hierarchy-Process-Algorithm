      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> ANALISA SUBKRITERIA NILAI AKADEMIK</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="POST" action="simpan_analisa_na.php">
                          <div class="form-group">
                              <div class="col-sm-10">
								...
								?>
								<input type="hidden" name="bn1" value="<?php echo "$C[5]"; ?>" >
								<input type="hidden" name="bn2" value="<?php echo "$C[11]"; ?>" >
								<input type="hidden" name="bn3" value="<?php echo "$C[17]"; ?>" >
								<input type="hidden" name="bn4" value="<?php echo "$C[23]"; ?>" >

								
								<input type="hidden" name="n1" value="<?php echo "$B[0]"; ?>" >
								<input type="hidden" name="n2" value="<?php echo "$B[1]"; ?>" >
								<input type="hidden" name="n3" value="<?php echo "$B[2]"; ?>" >
								<input type="hidden" name="n4" value="<?php echo "$B[3]"; ?>" >
								<input type="hidden" name="n5" value="<?php echo "$B[4]"; ?>" >
								<input type="hidden" name="n6" value="<?php echo "$B[5]"; ?>" >
								<input type="hidden" name="n7" value="<?php echo "$B[6]"; ?>" >
								<input type="hidden" name="n8" value="<?php echo "$B[7]"; ?>" >
								<input type="hidden" name="n9" value="<?php echo "$B[8]"; ?>" >
								<input type="hidden" name="n10" value="<?php echo "$B[9]"; ?>" >
								<input type="hidden" name="n11" value="<?php echo "$B[10]"; ?>" >
								<input type="hidden" name="n12" value="<?php echo "$B[11]"; ?>" >
								<input type="hidden" name="n13" value="<?php echo "$B[12]"; ?>" >
								<input type="hidden" name="n14" value="<?php echo "$B[13]"; ?>" >
								<input type="hidden" name="n15" value="<?php echo "$B[14]"; ?>" >
								<input type="hidden" name="n16" value="<?php echo "$B[15]"; ?>" >
								<input type="hidden" name="n17" value="<?php echo "$B[16]"; ?>" >
								<input type="hidden" name="n18" value="<?php echo "$B[17]"; ?>" >
								<input type="hidden" name="n19" value="<?php echo "$B[18]"; ?>" >
								<input type="hidden" name="n20" value="<?php echo "$B[19]"; ?>" >
								</table> 
								...
								<table>
								<form method="POST" action="cek_konsistensi_subkriteria_na.php">
								<input type="hidden" name="bn1" value="<?php echo "$C[5]"; ?>" >
								<input type="hidden" name="bn2" value="<?php echo "$C[11]"; ?>" >
								<input type="hidden" name="bn3" value="<?php echo "$C[17]"; ?>" >
								<input type="hidden" name="bn4" value="<?php echo "$C[23]"; ?>" >
