      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DATA SUBKRITERIA PERILAKU </h3>
                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[p6]</td>
								 <td>
								<a href='edit_data_subkriteria_pl.php?id_perilaku=$data[id_perilaku]'>Edit</a>
								<a href='aksi_hapus_subkriteria_pl.php?id_perilaku=$data[id_perilaku]'>Hapus</a>
								<a href='analisa_subkriteria_pl.php?id_perilaku=$data[id_perilaku]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
