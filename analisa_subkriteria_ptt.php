      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> ANALISA SUBKRITERIA PELANGGARAN TATA TERTIB </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_hitung_subkriteria_ptt.php">
                              ...
                              <div class="col-sm-10">
								<table class="table table-bordered table-striped table-condensed" border="1" width='500' align="center" >
									...
									<tr>
										...
										<td> 
										<input type="text" name="t5" value="1">
										</td>
										<td> 
									...
									<tr>
										...
										<td> 
										<input type="text" name="t9" value="1">
										</td>
									</tr>
