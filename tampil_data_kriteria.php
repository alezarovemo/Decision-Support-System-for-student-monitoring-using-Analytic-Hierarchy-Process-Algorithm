      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DATA ALTERNATIF </h3>
                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[k20]</td>
								 <td>
								<a href='edit_data_kriteria.php?id_kriteria=$data[id_kriteria]'>Edit</a>
								<a href='aksi_hapus_kriteria.php?id_kriteria=$data[id_kriteria]'>Hapus</a>
								<a href='analisa_kriteria.php?id_kriteria=$data[id_kriteria]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
