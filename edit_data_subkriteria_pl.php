      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> EDIT DATA SUBKRITERIA PERILAKU </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <?php
						include "koneksi.php";
						$sql="select * from t_perilaku where
						id_perilaku='$_GET[id_perilaku]'";
						$tampil=mysql_query($sql);
						$data=mysql_fetch_array($tampil);
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_update_data_subkriteria_pl.php">
                          <div class="form-group">
                              ...
                              <tr>
								  ...
								  <td class="numeric"><input type="text" value="<?php echo "$data[p2]"; ?>"></td>
								  <input type="hidden" name="id_perilaku2" value="<?php echo "$data[id_perilaku]"; ?>">
                                  <td class="numeric">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric">Rajin</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[p3]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">Sedang</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[p6]"; ?>"></td>
                                  <td class="numeric">
