      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> INPUT DATA SUBKRITERIA SIKAP </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_update_data_subkriteria_sk.php">
                          <div class="form-group">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric"> Baik</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[s2]"; ?>"></td>
								  <input type="hidden" name="id_sikap2" value="<?php echo "$data[id_sikap]"; ?>">
                                  <td class="numeric">
                                  ...
                                  <td class="numeric">Cukup</td>
                              </tr>
                              <tr>
                                 
                                  <td class="numeric">Baik</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[s3]"; ?>"></td>
                                  <td class="numeric">
                                  ...
                                  <td class="numeric"> Buruk </td>
                              </tr>
                              <tr>
                                  <td class="numeric">Cukup</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[s6]"; ?>"></td>
                                  <td class="numeric">
								  <select name="s6" class="form-control">
										 <option value="1" > 1.  Sama Pentingnya </option>
										 <option value="2" > 2.  Mendekati Sedikit Lebih Pentingnya </option>
										 <option value="3" > 3.  Sedikit Lebih Penting </option>
										 <option value="4" > 4.  Mendekati Lebih Penting Dari </option>
