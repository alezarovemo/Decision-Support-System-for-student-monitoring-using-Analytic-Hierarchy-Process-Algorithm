          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					  ...
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_hitung_subkriteria_na.php">
                              ...
                              <div class="col-sm-10">
								<table class="table table-bordered table-striped table-condensed" border="1" width='700' align="center" >
									...
									<tr>
										...
										<td>
										<input type="text" name="n2" value="<?php echo "$data[n2]"; ?>">
										</td>  
										<td> 
										<input type="text" name="n3" value="<?php echo "$data[n3]"; ?>">
										</td>
										<td> 
										<input type="text" name="n4" value="<?php echo "$data[n4]"; ?>">
										</td>		
									</tr>
									<tr>
										<td>61-80</td>
										<td> 
										<input type="hidden" name="n5" >
										</td>
										<td> 
										<input type="text" name="n6" value="1">
										</td>
										<td> 
										<input type="text" name="n7" value="<?php echo "$data[n7]"; ?>">
										</td>
										<td> 
										<input type="text" name="n8" value="<?php echo "$data[n8]"; ?>">
										</td>
									</tr>
									<tr>
										<td>41-60</td>
										<td>
										<input type="hidden" name="n9">
									</td>
										<td>
										<input type="hidden" name="n10" >
										</td>
										<td> 
										<input type="text" name="n11" value="1">
										</td>
										<td> 
										<input type="text" name="n12" value="<?php echo "$data[n12]"; ?>">
										</td>
									</tr>
										<tr>
										<td>0-40</td>
										<td>
										<input type="hidden" name="n13">
									</td>
										<td>
										<input type="hidden" name="n14" >
										</td>
										<td> 
										<input type="hidden" name="n15" >
										</td>
										<td> 
										<input type="text" name="n16" value="1">
										</td>
									</tr>
									<tr>
										<td>Jumlah</td>
