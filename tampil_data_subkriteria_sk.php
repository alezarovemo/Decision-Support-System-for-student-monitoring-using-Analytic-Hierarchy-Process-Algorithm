      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DATA SUBKRITERIA SIKAP </h3>
                          ...
                          <div class="form-group">
                              ...
                              <tr>
							   <?php
								 ...
								 <td>$data[s6]</td>
								 <td>
								<a href='edit_data_subkriteria_sk.php?id_sikap=$data[id_sikap]'>Edit</a>
								<a href='aksi_hapus_subkriteria_sk.php?id_sikap=$data[id_sikap]'>Hapus</a>
								<a href='analisa_subkriteria_sk.php?id_sikap=$data[id_sikap]'>Analisa</a>
								 </td>
								 </tr>";
								 }
								 ?>
