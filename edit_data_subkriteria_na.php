      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> EDIT DATA SUBKRITERIA NILAI AKADEMIK</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <?php
						include "koneksi.php";
						$sql="select * from t_nilai where
						id_nilai='$_GET[id_nilai]'";
						$tampil=mysql_query($sql);
						$data=mysql_fetch_array($tampil);
					  ?>
                      <form class="form-horizontal style-form" method="POST" action="aksi_update_data_subkriteria_na.php">
                          <div class="form-group">
                              ...
                              <tr>
								 ...
								 <td class="numeric"><input type="text" value="<?php echo "$data[n2]"; ?>"></td>
								  <input type="hidden" name="id_nilai2" value="<?php echo "$data[id_nilai]"; ?>">
                                  <td class="numeric">
                              ...
                              <tr>
                                  ...
                                  <td class="numeric">81 - 100</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[n3]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">81 - 100</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[n4]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>                             
                                  <td class="numeric">61 - 80</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[n7]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">61 - 80</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[n8]"; ?>"></td>
                                  <td class="numeric">
                              ...
                              <tr>
                                  <td class="numeric">41 - 60</td>
								  <td class="numeric"><input type="text" value="<?php echo "$data[n12]"; ?>"></td>
                                  <td class="numeric">
